    ...
    children: [
      {
        ...
        meta: { title: "會員交易查詢1.0", id: 131, isValidation: true, islogin: true },
      },
      {
        path: "member-v1",
        name: "MemberV1",
        component: () => import("../views/customer-service/MemberV1.vue"),
        meta: { title: "會員資料維護1.0", id: 132, isValidation: true, islogin: true },
      },
      {
        path: "card-v1",
        name: "CardV1",
        component: () => import("../views/customer-service/CardV1.vue"),
        meta: { title: "票卡資料維護1.0", id: 133, isValidation: true, islogin: true },
      },
    ]
  },
  {
