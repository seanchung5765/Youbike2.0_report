import{G as N,ak as y,X as h,H as r,K as j,M as A,O as z,T as L,a1 as P,Q as g,F as T,bU as V,i as D,r as C,o as F,c as O,e,b as f,w as p,d as v,k as U,bR as $,N as k,j as b}from"./index-1103b7f9.js";import{A as R}from"./AlertCircle-90aae55a.js";const E=N("divider",`
 position: relative;
 display: flex;
 width: 100%;
...
500101187,
500101213,
500111086,`,i=new Blob([s],{type:"text/plain;charset=utf-8"}),m=URL.createObjectURL(i),u=document.createElement("a");u.href=m,u.download="範例檔",document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(m)}const x=async()=>{const s=c.value;try{const i="http://127.0.0.1:3000/mail/listmail";(await U.put(i,{carnum:s})).data.message==="編輯成功"&&(o.value.value=null,d("編輯成功"))}catch(i){console.log(i)}};return(s,i)=>(F(),O("div",M,[I,e("div",G,[e("div",K,[e("div",Q,[f(v(k),{trigger:"hover"},{trigger:p(()=>[f(v($),{size:"20",color:"#0DCAF0"},{default:p(()=>[f(v(R))]),_:1})]),default:p(()=>[W]),_:1}),X])]),e("div",q,[e("div",J,[f(v(k),{trigger:"hover"},{trigger:p(()=>[f(v($),{size:"20",color:"#0DCAF0"},{default:p(()=>[f(v(R))]),_:1})]),default:p(()=>[Y]),_:1}),Z])]),e("div",{class:"col-auto ms-auto"},[e("button",{class:"btn btn-primary fw-bold",onClick:_}," 下載範例檔案 ")])]),e("div",ee,[e("div",te,[e("input",{type:"file",class:"form-control",onChange:t,ref_key:"file",ref:o},null,544)])]),f(v(S)),e("div",{class:"row d-flex justify-content-center"},[e("button",{class:"btn btn-danger btn-lg",style:{width:"200px"},onClick:x}," 儲存 ")])]))}};export{ne as default};
